...
func TestUserRoutes(t *testing.T) {
	...
	t.Run("GET /v1/users", func(t *testing.T) {
		t.Run("should return 200 and apply the default query options", func(t *testing.T) {
			...
			assert.Equal(t, fixture.UserOne.ID, responseBody.Data[0].ID)
			assert.Equal(t, fixture.UserOne.Name, responseBody.Data[0].Name)
			assert.Equal(t, fixture.UserOne.Email, responseBody.Data[0].Email)
			assert.Equal(t, fixture.UserOne.Role, responseBody.Data[0].Role)
			assert.Equal(t, fixture.UserOne.VerifiedEmail, responseBody.Data[0].VerifiedEmail)
		})
		...
		t.Run("should limit returned array if limit param is specified", func(t *testing.T) {
			...
			assert.Equal(t, fixture.UserOne.ID, responseBody.Data[0].ID)
			assert.Equal(t, fixture.UserTwo.ID, responseBody.Data[1].ID)
		})
		...
		t.Run("should return the correct page if page and limit params are specified", func(t *testing.T) {
			...
			assert.Equal(t, fixture.Admin.ID, responseBody.Data[0].ID)
		})
	})
